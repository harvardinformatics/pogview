...
public final class AlignSeq {
  ...
  private String astr2 = "";

  private int seq1start;
  private int seq1end;
  private int seq2start;
  private int seq2end;
  ...
  private static final java.util.Hashtable dnaHash = new java.util.Hashtable();
  ...
  private static final String[] dna = {"C","T","A","G","-"};
  private static final String[] pep = {"A","R","N","D","C","Q","E","G","H","I","L","K","M","F","P","S","T","W","Y","V","B","Z","X","-"};

  private final int gapOpen = 120;
  private final int gapExtend = 20;

  private int[][] lookup = ResidueProperties.getBLOSUM62();
  private String[] intToStr = pep;
  private int defInt = 23;
  ...
  private void SeqInit(Sequence s1, Sequence s2,String type) {
  ...
  private int findTrace(int i,int j) {
    int t = 0;
  ...
  private int[] stringToInt(String s,String type) {
