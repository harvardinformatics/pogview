...
public final class RotatableCanvas extends Canvas implements MouseListener,
                                                       MouseMotionListener,
                                                       KeyListener,
                                                       RubberbandListener, 
  ...
  private void drawScene(Graphics g) {
    ...
    for (int i = 0; i < npoint; i++) {
      ...
      if (sp.sequence instanceof Sequence) {
        //if (((Sequence)sp.sequence).setColor(Color.black)) {
        //  g.setColor(Color.white);
        //} else {
          //setColor(((Sequence)sp.sequence).color);
       // }
      } else {
...
//      recty2 = evt.getY();
  ...
  private Sequence findPoint(int x, int y) {
